    ...
    <footer class="page-footer" role="contentinfo">
      <div class="page-footer__inner">
        <section class="page-footer__section">
          ...
          <br>
          <!-- <p class="page-footer__text">{{ 'pageFooter.contactsText' | translate }}</p>
          <div class="page-footer__links">
            <a href="https://t.me/denumismat" target="_blank" rel="noopener noreferrer" class="page-footer__link">Telegram</a>
            <a href="viber://chat?number=%2B1234567890" target="_blank" rel="noopener noreferrer" class="page-footer__link">Viber</a>
            <a href="https://wa.me/1234567890" target="_blank" rel="noopener noreferrer" class="page-footer__link">WhatsApp</a>
          </div> -->
        </section>

        <section class="page-footer__section page-footer__section--wide">
          <div class="page-footer__section-shipping-container">
