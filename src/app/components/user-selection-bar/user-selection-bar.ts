        ...
        <div class="selection-bar__inner">
          <div class="selection-bar__metrics">
            @if (selectionLimitReached()) {
              <span
                role="img"
                class="selection-bar__limit-icon"
                title="maximum selected coin exceeded"
                aria-label="maximum selected coin exceeded"
              >
                ...
                <div class="header__tooltip" role="tooltip">Hello</div>
              </span>
            }
